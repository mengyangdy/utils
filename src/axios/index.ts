...
import {CustomAxiosRequestConfig, FlatRequestInstance, MappedType, RequestInstance, RequestOption} from "@/axios/types";
import {createAxiosConfig, createDefaultOptions, createRetryOptions} from "./options";
import {BACKEND_ERROR_CODE, REQUEST_ID_KEY} from "@/axios/constant";
  ...
  instance.interceptors.response.use(
    async response => {
      ...
      const backendError = new AxiosError<ResponseData>(
        'the backend request error', BACKEND_ERROR_CODE, response.config, response.request, response
      )
